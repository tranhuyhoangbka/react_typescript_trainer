    ...
    <div>
       ...
       <ul className={"navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" + (isToggled ? ' toggled' : '')} id="accordionSidebar">
        ...
        <li className="nav-item">
          <a className={"nav-link " + (isComponentShow ? '' : 'collapsed')} href="/#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded={isComponentShow ? 'true' : 'false'} aria-controls="collapseTwo" onClick={()=>setIsComponentShow(!isComponentShow)}>
          ...
          <div id="collapseTwo" className={"collapse" + (isComponentShow ? ' show' : '')} aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <Link to="/users" className="collapse-item">Nguoi dung</Link>
